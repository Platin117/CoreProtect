...
public class VersionCheckService {
    ...
    public static boolean performVersionChecks() {
        try {
            ...
            if (VersionUtils.newVersion(ConfigHandler.PATCH_VERSION, VersionUtils.getPluginVersion())
                    && !VersionUtils.isBranch("dev")) {
                Chat.console(Phrase.build(Phrase.VERSION_INCOMPATIBLE, "CoreProtect",
                        "v" + VersionUtils.getPluginVersion()));
